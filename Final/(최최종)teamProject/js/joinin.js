...
function changePhone3() {
  ...
  if(phone1.length === 3 &&  phone2.length === 4 && phone3.length === 4) {
    document.querySelector(".admit_send").style = "background-color: var(--yellow); cursor: pointer; color: black" ;
...
admit_send.addEventListener("click", (e) => {
  ...
  function timer() {
    if(time >= 0) {
      ...
      if(infoCertNum.value.length === 4) {
        ...
        admit_finish.style.backgroundColor = "var(--yellow)";
  ...
  /* 인증완료 */
  admit_finish.addEventListener("click", (e) => {
    e.preventDefault();
...
//   } else {
//     admit_finish.disabled = true;
//     admit_finish.style.backgroundColor = "fff";
//   }
// })
